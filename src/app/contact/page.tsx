...
export default function Contact() {
    ...
    return (
      <div className="isolate bg-yellow-200 px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">Our support team is here for you.</p>
      </div>
      <form  className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit} noValidate>
        ...
        <div className="mt-10">
          <button
            type="submit"
            disabled={isLoading}
            className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-green-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
