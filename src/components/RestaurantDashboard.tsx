...
export function RestaurantDashboard() {
  ...
  if (currentView === 'menu') {
    return (
      <>
        <AdminHeader currentPage="menu" onNavigate={(page) => router.push(`/${page}`)} />
        <MenuList
          onAddNew={() => router.push('/menu/create-menu-item')}
          onEdit={() => router.push('menu')}
        />
      </>
    );
  }

  if (currentView === 'menu-add') {
    return (
      <>
        <AdminHeader currentPage="menu" onNavigate={handleNavigate} />
        <MenuItemForm
  ...
  if (currentView === 'orders') {
    return (
      <>
        <AdminHeader currentPage="orders" onNavigate={handleNavigate} />
        <OrdersList
  ...
  if (currentView === 'analytics') {
    return (
      <>
        <AdminHeader currentPage="analytics" onNavigate={handleNavigate} />
  ...
  return (
    <>
      <AdminHeader currentPage="home" onNavigate={handleNavigate} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <button
                onClick={() => setCurrentView('menu-add')}
